...
export default function SimulationPage() {
  ...
  const setPair = (id) => {
    const next = mockThreats.find((threat) => threat.id === id)
    if (next) {
    ...
    <section className="simulation-page">
      ...
      <aside className="simulation-config" aria-label="Simulation configuration">
        ...
        <div className="simulation-section">
          ...
          <div className="simulation-object-preview">
            <span>{selectedPair.objectA}</span>
            <i>×</i>
            <span>{selectedPair.objectB}</span>
          </div>
        </div>
      ...
      <aside className="simulation-status" aria-live="polite">
        ...
        <div className="simulation-status-title">
          <strong>{selectedPair.objectA}</strong>
          <span>×</span>
          <strong>{selectedPair.objectB}</strong>
        </div>
